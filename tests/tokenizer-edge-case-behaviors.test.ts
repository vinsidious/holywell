...
describe('readQuotedString position tracking', () => {
...
describe('indexOf for dollar-quoted strings', () => {
...
describe('Operator longest-match order', () => {
...
describe('Identifier length check timing', () => {
...
describe('Quoted identifier length check includes quotes', () => {
...
describe('Underscore handling in numbers', () => {
...
describe('Hex number edge cases', () => {
...
describe('Token count approaching limit', () => {
...
describe('Block comment does NOT nest in standard SQL', () => {
  it('closes at first */', () => {
...
describe('Line comment trims trailing whitespace', () => {
...
describe('Punctuation includes colon for array slicing', () => {
...
describe('Unexpected character error format', () => {
...
describe('U& Unicode escape strings', () => {
...
describe('isKeyword check for keyword vs identifier', () => {
...
describe('Line offset calculation for error reporting', () => {
