...
const KEYWORD_LIST = [
  'ABSOLUTE', 'ACTION', 'ADD', 'ALTER', 'AND', 'APPLY', 'ARRAY', 'AS', 'ASC',
  ...
  'CURRENT_USER', 'CURSOR',
  'DATA', 'DATABASE', 'DATE', 'DATETIME', 'DECIMAL', 'DECLARE', 'DEFAULT', 'DELETE',
  'DESC', 'DISTINCT', 'DO', 'DOUBLE', 'DROP',
  'ELSE', 'END', 'ENGINE', 'ESCAPE', 'EXCEPT', 'EXCLUDE', 'EXCLUDED', 'EXECUTE',
  ...
  'UNBOUNDED', 'UNION', 'UNIQUE', 'UNPIVOT', 'UNSIGNED', 'UPDATE', 'USER', 'USING', 'UUID',
...
const FUNCTION_KEYWORD_LIST = [
  ...
  'DAY', 'DENSE_RANK', 'EXISTS', 'EXTRACT', 'FIRST_VALUE', 'FLOOR',
